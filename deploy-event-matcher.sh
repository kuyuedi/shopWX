...
echo ""
echo "=== Deploying Event Matcher to Japan Server ==="
...
echo "=== Building and starting Event Matcher ==="
docker compose build event-matcher
docker compose up -d event-matcher

echo "=== Deployment complete ==="
echo "Checking container status..."
sleep 5
docker compose ps event-matcher
echo ""
echo "=== Recent logs ==="
docker compose logs --tail 30 event-matcher

ENDSSH

echo "=== Event Matcher deployment finished ==="
