...
echo ""
echo "=== Deploying Kalshi Listener to Japan Server ==="
...
echo "=== Building and starting Kalshi listener ==="
docker compose build kalshi-listener
docker compose up -d kalshi-listener

echo "=== Deployment complete ==="
echo "Checking container status..."
sleep 5
docker compose ps kalshi-listener
echo ""
echo "=== Recent logs ==="
docker compose logs --tail 30 kalshi-listener
...
echo "=== Kalshi deployment finished ==="
