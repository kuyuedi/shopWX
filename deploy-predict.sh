...
echo ""
echo "=== Deploying Predict.fun Listener to Japan Server ==="
...
echo "=== Building and starting Predict.fun listener ==="
docker compose build predict-listener
docker compose up -d predict-listener

echo "=== Deployment complete ==="
echo "Checking container status..."
sleep 5
docker compose ps predict-listener
echo ""
echo "=== Recent logs ==="
docker compose logs --tail 30 predict-listener
...
echo "=== Predict.fun listener deployment finished ==="
